...
import { ArrowLeft, Download, FileText, Video, MessageSquare } from 'lucide-react'
          ...
          <CardContent>
            {interview.score ? (
              <div className="space-y-2">
                <p className="text-3xl font-bold text-primary">{interview.score}%</p>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    <p>
                      <span className="font-medium">Name:</span> {interview.candidateName}
                    </p>
                    <p>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {Object.entries(interview.aiScores).map(([key, value]) => (
                ...
                <div className="space-y-4">
                  <div className="rounded-lg bg-muted p-4">
                    <p className="text-sm whitespace-pre-wrap">
                      {interview.hrNotes || interview.notes || 'No notes available'}
                    </p>
                  </div>
